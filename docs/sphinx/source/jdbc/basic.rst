...
This guide covers using JDBC to interact with the RelationalDBX's SQL interface.

Driver Setup
============

The RelationalDBX provides two JDBC drivers depending on your deployment architecture:

- **Embedded Driver**: For applications running in the same JVM as the RelationalDBX
- **Server Driver**: For client applications connecting to a remote RelationalDBX server via gRPC
...
.. tab-set::
      ...
      **Maven Dependency:**
      ...
      .. code-block:: xml
         ...
         <dependency>
             ...
             <artifactId>relationaldbx-relational-core</artifactId>
   ...
   .. tab-item:: Server Driver
      ...
      The server driver class ``com.apple.foundationdb.relational.jdbc.JDBCRelationalDriver`` connects to a remote RelationalDBX server via gRPC. It is also registered with Java's `Service Loader <https://docs.oracle.com/javase/8/docs/api/java/util/ServiceLoader.html>`_.
      ...
      **Maven Dependency:**
      ...
      .. code-block:: xml
         ...
         <dependency>
             <groupId>org.foundationdb</groupId>
             <artifactId>relationaldbx-relational-jdbc</artifactId>
             <version>VERSION_NUMBER</version>
         </dependency>
...
.. tab-set::
   ...
   .. tab-item:: Server Driver
      ...
      **Examples:**
      ...
      Connecting to a RelationalDBX server:
      ...
      **Connection Parameters:**
      ...
      - **host**: The hostname or IP address of the RelationalDBX server
...
- :doc:`../GettingStarted` - Introduction to the RelationalDBX
