...
SAMPLE_DIFF = """\
diff --git a/relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java b/relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java
index abc1234..def5678 100644
--- a/relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java
+++ b/relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java
...
+    new line 13
     existing line
diff --git a/relationaldbx-core/src/main/java/com/apple/foundationdb/record/query/QueryPlanner.java b/relationaldbx-core/src/main/java/com/apple/foundationdb/record/query/QueryPlanner.java
--- a/relationaldbx-core/src/main/java/com/apple/foundationdb/record/query/QueryPlanner.java
+++ b/relationaldbx-core/src/main/java/com/apple/foundationdb/record/query/QueryPlanner.java
...
class TestRepoPathToJacocoKey(unittest.TestCase):
    ...
    def test_standard_java_path(self):
        path = 'relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java'
    ...
    def test_nested_module_path(self):
        path = 'relationaldbx-relational-layer/relationaldbx-relational-core/src/main/java/com/apple/foundationdb/relational/Foo.java'
        result = repo_path_to_jacoco_key(path)
        self.assertEqual(result, 'com/apple/foundationdb/relational/Foo.java')

    def test_no_match_test_source(self):
        path = 'relationaldbx-core/src/test/java/com/apple/foundationdb/record/TestFoo.java'
    ...
    def test_extensions_module(self):
        path = 'relationaldbx-extensions/src/main/java/com/apple/foundationdb/async/AsyncUtil.java'
        result = repo_path_to_jacoco_key(path)
...
class TestParseDiff(unittest.TestCase):
    ...
    def test_parses_added_lines(self):
        ...
        try:
            ...
            file_path = 'relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java'
    ...
    def test_parses_multiple_files(self):
        ...
        try:
            ...
            self.assertIn(
                'relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java',
                result)
            self.assertIn(
                'relationaldbx-core/src/main/java/com/apple/foundationdb/record/query/QueryPlanner.java',
                result)
        finally:
            os.unlink(path)
...
"""
    ...
    def test_diff_with_non_utf8_bytes(self):
        ...
        diff_bytes = (
            ...
            b'diff --git a/relationaldbx-core/src/main/java/com/apple/'
            b'foundationdb/record/FDBRecordStore.java '
            b'b/relationaldbx-core/src/main/java/com/apple/foundationdb/'
            b'record/FDBRecordStore.java\n'
            b'--- a/relationaldbx-core/src/main/java/com/apple/foundationdb/'
            b'record/FDBRecordStore.java\n'
            b'+++ b/relationaldbx-core/src/main/java/com/apple/foundationdb/'
            b'record/FDBRecordStore.java\n'
            b'@@ -10,2 +10,3 @@\n'
        ...
        try:
            ...
            java_path = ('relationaldbx-core/src/main/java/com/apple/'
...
class TestGenerateAnnotations(unittest.TestCase):
    ...
    def test_generates_one_annotation_per_file(self):
        diff_data = {
            'relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java': {12, 13},
            'relationaldbx-core/src/main/java/com/apple/foundationdb/record/query/QueryPlanner.java': {100},
        }
    ...
    def test_skips_files_without_coverage(self):
        diff_data = {
            'relationaldbx-core/src/main/java/com/apple/foundationdb/record/Unknown.java': {10},
        }
        annotations = generate_annotations(self.coverage_data, diff_data, None)
        self.assertEqual(len(annotations), 0)
    ...
    def test_skips_test_files(self):
        diff_data = {
            'relationaldbx-core/src/test/java/com/apple/foundationdb/record/FDBRecordStoreTest.java': {10},
        }
        annotations = generate_annotations(self.coverage_data, diff_data, None)
        self.assertEqual(len(annotations), 0)
    ...
    def test_skips_files_with_only_deletions(self):
        diff_data = {
            'relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java': set(),
        }
        annotations = generate_annotations(self.coverage_data, diff_data, None)
        self.assertEqual(len(annotations), 0)
    ...
    def test_annotation_contains_coverage_data(self):
        diff_data = {
            'relationaldbx-core/src/main/java/com/apple/foundationdb/record/FDBRecordStore.java': {12, 13, 14},
        }
        annotations = generate_annotations(self.coverage_data, diff_data, None)
