...
def main(argv: list[str]):
    ...
    parser.add_argument('--repository', default='FoundationDB/relationaldbx', help="Repository")
...
class TestStringMethods(unittest.TestCase):
    ...
    def test_format_empty_notes(self) -> None:
        self.assertEqual('\n\n**[Full Changelog (4.1.8.0...4.2.1.0)](https://github.com/FoundationDB/relationaldbx/compare/4.1.8.0...4.2.1.0)**\n\n' +
                         'Mixed Mode Results\n',
                         format_notes([], self.simple_label_config(), '4.1.8.0', '4.2.1.0',
                                      'FoundationDB/relationaldbx', 'Mixed Mode Results'))
