...
PROJECT_TO_URL_MAP = {
    ...
    'relationaldbx-java': 'https://apple.github.io/foundationdb/javadoc/',
    'protobuf': 'https://developers.google.com/protocol-buffers/docs/reference/java/',
    'relationaldbx-extensions': 'https://javadoc.io/page/org.foundationdb/relationaldbx-extensions/latest/',
    'relationaldbx-core': 'https://javadoc.io/page/org.foundationdb/relationaldbx-core/latest/',
}

# Packages to filter out from each project
EXCLUDED_PACKAGES = {
    'java': {'javax.annotations'},
    'relationaldbx-extensions': {'com.apple.foundationdb', 'com.apple.foundationdb.tuple', 'com.apple.foundationdb.async'},
}
