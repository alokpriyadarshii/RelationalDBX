...
public class FDBFilterCoalescingQueryTest extends FDBRecordStoreQueryTestBase {
    ...
    public void duplicateFilters() throws Exception {
        ...
        if (planner instanceof RecordQueryPlanner) {
            ...
            //  Some query plans include redundant filtering operations even when the index is a complete specification (https://github.com/FoundationDB/relationaldbx/issues/2)
     ...
     * TODO: Planner does not currently coalesce overlapping filters (https://github.com/FoundationDB/relationaldbx/issues/1)
     */
    @DualPlannerTest
