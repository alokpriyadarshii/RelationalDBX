...
class OnlineIndexerMultiTargetTest extends OnlineIndexerTest {
    ...
    void benchMarkMultiTarget() {
        ...
        // (As in `:relationaldbx-core:test --tests "com.apple.foundationdb.record.provider.foundationdb.OnlineIndexerMultiTargetTest.benchMarkMultiTarget" -Ptests.nightly=true`)
