...
public class FDBSimpleQueryGraphTest extends FDBRecordStoreQueryTestBase {
    ...
    @DualPlannerTest(planner = DualPlannerTest.Planner.CASCADES)
    @Disabled(value = "Null-on-empty quantifiers must be below selects until we address: https://github.com/FoundationDB/relationaldbx/issues/3431")
     ...
     * <a href="https://github.com/FoundationDB/relationaldbx/issues/2881">Issue #2881</a>. This makes the
    ...
    void testEqualityAndSimpleExistentialPredicate() {
        ...
        final var plan = planGraph(
                () -> {
                    ...
                    // See: https://github.com/FoundationDB/relationaldbx/issues/2883
