...
public class FDBRecordStorePerformanceTest {
    ...
    // export $(tail +2 fdb-environment.properties) && java -Dlog4j.configurationFile=standalone.log4j.properties -jar ./relationaldbx-core/.out/libs/relationaldbx-core-*-SNAPSHOT-standalone-tests.jar
