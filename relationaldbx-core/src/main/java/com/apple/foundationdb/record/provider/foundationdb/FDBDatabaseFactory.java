...
public abstract class FDBDatabaseFactory {
     ...
     * supported FDB API versions, the RelationalDBX will attempt to guard those features so that they are
     ...
     * on this database factory, as other RelationalDBX APIs should hide API-version compatibility code so
