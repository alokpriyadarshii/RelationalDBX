...
public class RecordQueryStreamingAggregationPlan extends AbstractRelationalExpressionWithChildren implements RecordQueryPlanWithChild {
    ...
    public static RecordQueryStreamingAggregationPlan of(@Nonnull final Quantifier.Physical inner,
        ...
        // TODO: this is a temporary workaround for https://github.com/FoundationDB/relationaldbx/issues/3979, as
        //       older versions of relationaldbx didn't correctly handle a null groupingKeyValue with continuations.
        ...
        //       in https://github.com/FoundationDB/relationaldbx/issues/4108.
