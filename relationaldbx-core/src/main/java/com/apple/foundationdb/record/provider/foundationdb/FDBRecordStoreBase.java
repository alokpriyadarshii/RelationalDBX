 ...
 * the RelationalDBX. A record store combines:
 *
 * <ul>
 ...
 * {@link FDBRecordContext#commitAsync()}. RelationalDBX transactions inherit all of the guarantees and limitations of
...
public interface FDBRecordStoreBase<M extends Message> extends RecordMetaDataProvider {
    ...
    interface UserVersionChecker {
         ...
         * default prior to RelationalDBX 3.0. Note that all indexes must be made {@link IndexState#WRITE_ONLY} before
         ...
         * <a href="https://github.com/foundationDB/relationaldbx/issues/7">Issue #7</a>), it may be more efficient
    ...
    enum VersionstampSaveBehavior {
         ...
         *
         * <p>
         * Note: due to <a href="https://github.com/FoundationDB/relationaldbx/issues/964">Issue #964</a>, on some
     ...
     * See: <a href="https://github.com/FoundationDB/relationaldbx/issues/398">Issue #398</a>.
     * </p>
     *
    ...
    interface BaseBuilder<M extends Message, R extends FDBRecordStoreBase<M>> {
         ...
         * </p>
         * <p>
         *     When installing a new version of the RelationalDBX library that includes a format change, first install
