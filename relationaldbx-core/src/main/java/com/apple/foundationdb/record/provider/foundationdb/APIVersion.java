 ...
 * be RelationalDBX features that are gated on specific FDB API versions. For that reason, if there
 ...
 *
 * <p>
 * A note on RelationalDBX API stability: the elements of this enum are expected to shift as support
