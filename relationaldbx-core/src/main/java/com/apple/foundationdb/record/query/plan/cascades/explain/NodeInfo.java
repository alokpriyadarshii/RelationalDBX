...
/**
 * Explanatory information about the RelationalDBX's plan operators and storage objects.
 * <br>
 * Note that it is possible that users of the RelationalDBX may want to amend this set of info objects. Therefore, it is
