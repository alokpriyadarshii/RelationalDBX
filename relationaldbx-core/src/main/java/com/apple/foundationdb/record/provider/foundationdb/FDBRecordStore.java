 ...
 * changes to this in-memory state. See <a href="https://github.com/FoundationDB/relationaldbx/issues/489">Issue #489</a>
...
public class FDBRecordStore extends FDBStoreBase implements FDBRecordStoreBase<Message> {
     ...
     *
     * This version is returned from {@link UserVersionChecker#checkUserVersion} and does not have any meaning within the RelationalDBX core.
     ...
     * has more details on its usage. This was the default behavior prior to RelationalDBX version 3.0.
     *
     ...
     * data and then not being able to read it from instances running an older version of the RelationalDBX.
     * </p>
     *
     ...
     * used by the RelationalDBX to determine information including what meta-data version was used the last time
    ...
    protected CompletableFuture<Long> getRecordCountForRebuildIndexes(boolean newStore, boolean rebuildRecordCounts,
        ...
        if (!rebuildRecordCounts) {
            try {
                ...
                // See: FDBRecordStoreBase.checkPossiblyRebuild() could take a long time if the record count index is split into many groups (https://github.com/FoundationDB/relationaldbx/issues/7)
    ...
    public void removeFormerIndex(FormerIndex formerIndex) {
        ...
        final long startTime = System.nanoTime();
        // This won't clear an ungrouped aggregate index: https://github.com/FoundationDB/relationaldbx/issues/3337
        ...
        if (formerIndexName != null) {
            ...
            // This will need to be adapted if we resolve: https://github.com/foundationdb/relationaldbx/issues/514
    ...
    protected boolean checkPossiblyRebuildRecordCounts(@Nonnull RecordMetaData metaData,
        ...
        if (rebuildRecordCounts) {
            ...
            // https://github.com/FoundationDB/relationaldbx/issues/3335
            if (existingStore) {
