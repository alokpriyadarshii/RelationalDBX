 ...
 * for index types defined outside of the RelationalDBX core.
 ...
 *
 * <p>
 * In addition to B-tree indexes, which provide lexicographic ordering of one or more key fields in the record, the RelationalDBX core includes some special indexes.
 * </p>
 * <ul>
