 ...
 * users of the RelationalDBX can define their own index types.
 *
 * This is a bit of a hack, and we should really fix it in the future.
 * TODO: Define index "behaviors" with defined contracts, for use in planning and index maintenance (https://github.com/FoundationDB/relationaldbx/issues/16)
 *
 * @see IndexTypes
 */
