...
public class ImplementRecursiveDfsJoinRule extends ImplementationCascadesRule<RecursiveUnionExpression> {
    ...
    // with the recursive union's upper select. See: https://github.com/FoundationDB/relationaldbx/issues/3649
    ...
    public void onMatch(@Nonnull final ImplementationCascadesRuleCall call) {
        ...
        // Note: this check will be removed once we have a fix for https://github.com/FoundationDB/relationaldbx/issues/3649
