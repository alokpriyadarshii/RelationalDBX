# RelationalDBX Lucene Index

The lucene index implementation on the RelationalDBX consists of several components.  The first component is a Directory implementation backed by an FDB KeySpace.
