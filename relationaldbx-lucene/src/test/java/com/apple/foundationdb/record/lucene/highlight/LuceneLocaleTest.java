    ...
    void highlightedNumberRangeQuery(Locale locale) {
        ...
        try {
            ...
            try (FDBRecordContext context = openContext()) {
                ...
                recordStore.saveRecord(LuceneIndexTestUtils.createComplexDocument(1623L, "Hello RelationalDBX", "Hello RelationalDBX 2", 5, 1_234_097, false, 8.123));
                recordStore.saveRecord(LuceneIndexTestUtils.createComplexDocument(1623L, "Hello RelationalDBX", "Hello RelationalDBX 2", -110_000_000, 999_999, false, 4.134059823));
                recordStore.saveRecord(LuceneIndexTestUtils.createComplexDocument(1623L, "Hello RelationalDBX", "Hello RelationalDBX 2", 51_000, 2_000_000, false, 9.2));
