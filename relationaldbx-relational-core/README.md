...
The [relationaldbx-relational-cli](../relationaldbx-relational-cli/README.md) comes with the embedded Driver bundled.

Relational also bundles a JDBC client Driver that talks GRPC to a Relational
Server/Service. See [Relational JDBC client Driver](../relationaldbx-relational-jdbc/README.md)
for more.
