...
public class GroupByQueryTests {
    ...
    @Disabled // Although Relational is generating a proper plan, this query fails because we don't have sophisticated mechanism in RecordLayer for understanding identifiers' derivations https://github.com/FoundationDB/relationaldbx/issues/1212
    ...
    @Disabled // this does not work, presumably because of https://github.com/FoundationDB/relationaldbx/issues/1212
