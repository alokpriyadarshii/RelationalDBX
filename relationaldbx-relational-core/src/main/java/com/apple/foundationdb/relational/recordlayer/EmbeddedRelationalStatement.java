...
public class EmbeddedRelationalStatement extends AbstractEmbeddedStatement implements RelationalStatement {
    ...
    @Override
    @SuppressWarnings("PMD.PreserveStackTrace") // intentional - Fall back for Invalid Range Exception from RelationalDBX
    public void executeDeleteRange(@Nonnull String tableName, @Nonnull KeySet prefix, @Nonnull Options options) throws SQLException {
        ...
        ensureTransaction(() -> {
            ...
            try {
                ...
                // To work around a RelationalDBX limitation, we execute point deletes at this point if we cannot execute a range delete
